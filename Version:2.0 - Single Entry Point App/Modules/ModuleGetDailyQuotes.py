# GeminiBlog-Version:2.0/ModuleGetDailyQuotes.py
#content in FetchDailyQuotespy
import requests
import json
import random
...
def QuotablesIO():
    logging.info("Inside QuotablesIO")
    print("Inside QuotablesIO")
...
def LocalQuoteIO():
    logging.info("Inside LocalQuoteIO")
    print("Inside LocalQuoteIO")
...
def ZenQuotesIO() :
    logging.info("Inside ZenQuotesIO")
    print("Inside ZenQuotesIO")
