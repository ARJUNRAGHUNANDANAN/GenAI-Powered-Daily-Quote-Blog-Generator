# GeminiBlog/Modules/ModulePoemGenerator.py
# @arjunraghunandanan 2024
# Poem generation using Gemini AI Studio
...
def generate_poem_from_source(quote: str, source: str) -> str:  
    ...
    if source == 'Gemini':
        ...
        print("You have selected OpenAI. This Code is Disabled at the moment, Please use Gemini")
        print("The program will continue to generate an image but it will not do further processing")
        ...
        print("You have selected Perplexity. This Code has not been tested extensively hence is disabled at the moment, Please use Gemini")
        print("The program will continue to generate an image but it will not do further processing")
